...
@include('layout.menu')
    ...
    <div class="row" id="work" style="margin-top: 120px;">
      ...
      <div class="col-10 col-md-10" id="center_wind" style="background: #CBDEB7; min-height: 385px; max-height: 385px; margin-right: -16px; text-align: center;  border-style:solid; border-width: 1px; border-color:#9BAB8A; overflow: auto scroll;"> 
